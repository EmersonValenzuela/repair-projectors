...
<title>Proyectores | Servitec Peru</title>
...
<div class="theme-layout boxed">
				...
				<div class="header-sec">
					<div class="col-md-6">
						<div class="app-header-info">
							<span>MANTENIMIENTO Y REPARACIÓN DE </span>
							<h1>PROYECTORES</h1>
							<h2>¿IMAGEN CON PUNTOS? ¿SE APAGA O SE REINICIA SOLO?</h2> <h2>¡Tenemos la solución!</h2>
	...
	<section class="block no-padding dark">
		<ul class="clients" id="carousal">
			<li><a href="#" title=""><img src="images/sony.png" alt="" height="150"/></a></li>
			<li><a href="#" title=""><img src="images/toshiba.png" alt="" height="150"></a></li>
			<li><a href="#" title=""><img src="images/1.png" alt="" height="150"/></a></li>
			<li><a href="#" title=""><img src="images/2.png" alt="" height="150"/></a></li>
			<li><a href="#" title=""><img src="images/m.png" alt="" height="120"/></a></li>
		</ul>
	</section>
...
<!--	
			...
			<div class="container">
				<div class="prdct-mock">
					<div class="row">
						...
						<div class="col-md-6">
							<h3>¿Cuál es la importancia de un <strong>Proyector</strong>?</h3>
							<p>En comparación con los televisores, los proyectores disfrutan de la ventaja inherente de los tamaños de pantalla más grandes. Así como las letras grandes son más fáciles de leer, también resulta más fácil para los ojos ver una pantalla más grande que una pequeña.</p>
						</div>
					</div>
				</div><!-- Product Mockup -->
			</div>
	...
	<section class="block remove-top dark"  id="blog">
		...
		$c=1;
           $sqli=mysqli_query($conn,"
            SELECT *
            FROM `servicios` 
            WHERE id_categoria_servicio = 4 and id_servicio= 36 or id_servicio = 37  or id_servicio = 38 ORDER BY `id_servicio` DESC");
           while ($row=mysqli_fetch_array($sqli)){
           ?>
		<div class="cool-features">	
			<div class="prdct-mockup">
				<a target="_blank" href="https://servitecperu.com/web/detalle_especialidad.php?id_servicio=<?php echo $row['id_servicio'];?>&id_categoria_servicio=4">
				<img src="images/services/<?=$row['foto']?>" alt="" width="70%"/>
		   </a>
			</div>
	...
	<section class="block remove-top dark">
		<div class="container">
           ...
           $sqli=mysqli_query($conn,"
            SELECT *
            FROM `servicios` 
            WHERE id_categoria_servicio = 4 and id_servicio= 38 or id_servicio = 39  or id_servicio = 40 or id_servicio = 41 or id_servicio = 42 ORDER BY `id_servicio` DESC");
           while ($row=mysqli_fetch_array($sqli)){
           ?>
					<div class="col-md-6">
						<div class="blog-post-sec">
							<div class="blog">
								<div class="post-thumb">
									...
									<a href="https://servitecperu.com/web/detalle_especialidad.php?id_servicio=<?php echo $row['id_servicio'];?>&id_categoria_servicio=4" title=""><i class="ti-link"></i></a>
								</div>
								<h3><a target="_blank" href="https://servitecperu.com/web/detalle_especialidad.php?id_servicio=<?php echo $row['id_servicio'];?>&id_categoria_servicio=4" title=""><?=utf8_encode($row['titulo'])?></a></h3>
								<p style="!important;font-weight:500;text-overflow:ellipsis;"><?= utf8_encode(getShortedString($row['descripcion'],225))?></p>
							</div>
						</div><!-- Blog Post -->
					</div>
					<?php } ?>
		...
		<div class="layer">
			...
			<div class="container">
				<div class="text-block2">
					<span>¿Necesitas un Experto para tu Proyector u otro dispositivo? </span>
	...
	<div class="whatsapp-escritorio">
      <a class="btn-whatsapp" target="_blank"
        href="https://api.whatsapp.com/send?phone=941801827&text=Tengo%20un%20problema%20con%20mi%20proyector"
    ...
    <div class="whatsapp-movil">
      ...
      <button class="btn-whatsapp" id="cambiar">
        <a target="_blank"
          href="https://api.whatsapp.com/send?phone=941801827&text=Tengo%20un%20problema%20con%20mi%20proyector"><i
...
//fin	
    ...
    <html>
    <head>
        <title>Email-Reparación Proyectores Consultas</title>
    </head>
    <body>
    <p>Este <strong>mensaje de consulta</strong> fue enviado desde  https://reparacion-proyectores.com/</p>
...
if (isset($_POST['enviar'])) {
   ...
   $subject = "Reparación Proyectores";
    ...
    <html>
    <head>
        <title>Email-Reparación Proyectores Mensaje</title>
    </head>
    <body>
    <p>Este <strong>mensaje de consulta</strong> fue enviado desde  https://reparacion-proyectores.com//</p>
    <table style='margin:0!important'>
